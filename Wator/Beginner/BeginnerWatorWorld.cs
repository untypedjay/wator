...
namespace VPS.Wator.Beginner
{
    public class BeginnerWatorWorld : IWatorWorld
    {
        ...
        public BeginnerWatorWorld(Settings settings)
        {
        ...
        public Point[] GetNeighbors(Type type, Point position)
        {
            ...
            if (type == null)
            {
                ...
                if (IsNullNeighborValid(type, i, j))
                {
        ...
        {
            if (type.IsInstanceOfType(Grid[i, j]))
            {
        ...
        private bool IsNullNeighborValid(Type type, int i, int j)
        {
            if (Grid[i, j] == null)
            {
                return true;
